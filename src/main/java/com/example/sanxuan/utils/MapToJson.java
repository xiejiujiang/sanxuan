package com.example.sanxuan.utils;

import com.alibaba.fastjson.JSONObject;
import com.example.sanxuan.entity.xcx.SaleOrderDetails;
import com.example.sanxuan.entity.xcx.XcxSaParam;
import com.example.sanxuan.entity.xcxpu.VoucherDetails;
import com.example.sanxuan.entity.xcxpu.XcxPuParam;
import com.example.sanxuan.saentity.SaleDeliveryDetails;
...
public class MapToJson {
    ...
    public static String getUnitByCode(String chcode,com.example.sanxuan.saentity.JsonRootBean sajrb){
        String unit = "个";
    ...
    // 创建 销售订单 STRING
    public static String createSaPUOrderDTO(XcxSaParam xcxSaParam){
        Map<String,Object> dto = new HashMap<String,Object>();
        Map<String,Object> sa = new HashMap<String,Object>();
        ...
        sa.put("DynamicPropertyValues",biaotoulistvalue);
        ...
        for(int i=0;i<xcxSaParam.getSaleOrderDetails().size();i++ ){
            ...
            DetailM.put("Unit",DetailMUnit);
            DetailM.put("Quantity", xcxSaParam.getSaleOrderDetails().get(i).getQuantity());
